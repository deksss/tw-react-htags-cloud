...
const Twitter = (() => {
  return class Twitter {
    ...
    get(url, params = {}) {
      ...
      const components = buildComponents.call(
        this,
        "GET",
        url,
        Object.assign({ callback }, params)
      );
      ...
      return new Promise((resolve, reject) => {
        ...
        .catch(e => {
          ...
          delete window[callback];
          throw {
            error: `${e ? "Load" : "Timeout"} Error (This is a dummy message)`
          };
        });
    }
    ...
    post(url, params = {}) {
      ...
      return new Promise((resolve, reject) => {
        ...
        iframe.addEventListener("load", () =>
          resolve({
            message:
              "Probably the POST request has been sent. (This is a dummy message)"
          })
        );
